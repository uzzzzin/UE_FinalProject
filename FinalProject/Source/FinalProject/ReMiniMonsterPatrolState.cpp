...
#include "ReMiniMonsterPatrolState.h"
#include "Object/MiniMonster/MiniMonster.h"
#include "Component/StateMachineComponent.h"
#include "FSM/MiniMonsterFSM.h"

UReMiniMonsterPatrolState::UReMiniMonsterPatrolState()
	: speed(200.f)
	, rotSpeed(3.f)
{
}

void UReMiniMonsterPatrolState::Enter()
{
...
void UReMiniMonsterPatrolState::Update(float DeltaTime)
{
...
void UReMiniMonsterPatrolState::Exit()
{
	speed = 200.f;
}
